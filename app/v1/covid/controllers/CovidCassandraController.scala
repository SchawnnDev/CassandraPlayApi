...
@Singleton
@Api(value = "Covid DataSet using Cassandra Controller", produces = "application/json")
class CovidCassandraController @Inject()(val controllerComponents: ControllerComponents, repo: CovidCassandraRepository)
